...
class Qwen3Wrapper:
    """
    Wrapper for Qwen-3 models using TransformerLens.
    ...
    def __init__(
        self,
        model_name: str = "qwen/qwen-3-8b-it",
        device: str = "cuda",
        ...
        """
        Args:
            model_name: Qwen-3 checkpoint supported by TransformerLens
                        (e.g. "qwen/qwen-3-8b-it")
            device: "cuda" or "cpu"
    ...
    def get_stance_token_ids(self, language: str = "pt") -> Tuple[int, int]:
        ...
        Qwen is space-sensitive; keep leading space.
        """
        if language == "pt":
            pos = "Con"
            neg = "Dis"
